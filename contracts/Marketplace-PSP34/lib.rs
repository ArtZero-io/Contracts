...
pub mod artzero_marketplace_psp34 {
    ...
    impl EnumerableMapping {
        pub fn insert(
            ...
            self.id_to_index.insert(&(nft_contract_address, seller, id.clone()), &index.clone());
            self.index_to_id.insert(&(nft_contract_address, seller, index.clone()), &id.clone());
        }
        ...
        pub fn remove(
            ...
            let index = self
                .id_to_index
                .get(&(nft_contract_address, seller, id.clone()))
            ...
            self.id_to_index.remove(&(nft_contract_address, seller, id.clone()));
    ...
    impl ArtZeroMarketplacePSP34 {
        ...
        pub fn buy(&mut self, nft_contract_address: AccountId, token_id: Id) -> Result<(), Error> {
            ...
            self.manager.current_profit = self
                ...
                .unwrap();
            let royal_fee_rate =
                CollectionRef::get_royal_fee(&self.manager.collection_contract_address, nft_contract_address);
            let royal_fee = price
            ...
            let collection_owner =
                CollectionRef::get_collection_owner(&self.manager.collection_contract_address, nft_contract_address);
        ...
        pub fn bid(&mut self, nft_contract_address: AccountId, token_id: Id) -> Result<(), Error> {
            ...
            assert!(self
                .manager
                .sale_tokens_ids
                .get_by_id(Some(nft_contract_address), Some(seller), token_id.clone())
                .is_ok());
        ...
        fn update_listed_token_by_collection_address(&mut self, nft_contract_address: AccountId, mode: bool) {
            ...
            let mut listed_token_count_unwarp = 1;
