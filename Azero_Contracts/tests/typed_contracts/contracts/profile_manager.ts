...
import ABI from '../../artifacts/profile_manager.json';
import QueryMethods from '../query/profile_manager';
import BuildExtrinsicMethods from '../build-extrinsic/profile_manager';
import TxSignAndSendMethods from '../tx-sign-and-send/profile_manager';
import MixedMethods from '../mixed-methods/profile_manager';
import EventsClass from '../events/profile_manager';
