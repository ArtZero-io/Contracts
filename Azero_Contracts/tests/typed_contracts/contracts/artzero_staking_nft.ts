...
import ABI from '../../artifacts/artzero_staking_nft.json';
import QueryMethods from '../query/artzero_staking_nft';
import BuildExtrinsicMethods from '../build-extrinsic/artzero_staking_nft';
import TxSignAndSendMethods from '../tx-sign-and-send/artzero_staking_nft';
import MixedMethods from '../mixed-methods/artzero_staking_nft';
import EventsClass from '../events/artzero_staking_nft';
