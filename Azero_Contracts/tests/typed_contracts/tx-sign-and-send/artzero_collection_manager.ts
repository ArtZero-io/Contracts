...
export default class Methods {
	...
	"get_attributes" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getAttributes", [contractAddress, attributes], __options);
	}
	...
	"get_attribute" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getAttribute", [contractAddress, attributeKey], __options);
	}
	...
	"has_attribute" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "hasAttribute", [contractAddress, attributeKey], __options);
	}
	...
	"get_collection_attribute_index" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getCollectionAttributeIndex", [contractAddress, attributeKey], __options);
	}
	...
	"get_collection_attribute_count" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getCollectionAttributeCount", [contractAddress], __options);
	}
	...
	"get_collection_by_address" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getCollectionByAddress", [nftContractAddress], __options);
	}
	...
	"get_collections_by_owner" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getCollectionsByOwner", [ownerAddress], __options);
	}
	...
	"get_contract_by_id" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getContractById", [id], __options);
	}
	...
	"get_collection_count" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getCollectionCount", [], __options);
	}
	...
	"get_active_collection_count" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getActiveCollectionCount", [], __options);
	}
	...
	"get_simple_mode_adding_fee" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getSimpleModeAddingFee", [], __options);
	}
	...
	"get_advance_mode_adding_fee" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getAdvanceModeAddingFee", [], __options);
	}
	...
	"get_max_royalty_fee_rate" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getMaxRoyaltyFeeRate", [], __options);
	}
	...
	"ArtZeroCollectionTrait::get_collection_owner" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "artZeroCollectionTrait::getCollectionOwner", [nftContractAddress], __options);
	}
	...
	"ArtZeroCollectionTrait::is_active" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "artZeroCollectionTrait::isActive", [nftContractAddress], __options);
	}
	...
	"ArtZeroCollectionTrait::get_royalty_fee" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "artZeroCollectionTrait::getRoyaltyFee", [nftContractAddress], __options);
	}
	...
	"ArtZeroCollectionTrait::get_contract_type" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "artZeroCollectionTrait::getContractType", [nftContractAddress], __options);
	}
