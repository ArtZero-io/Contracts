...
1. Some contracts are related to other contracts, use a deloyment account to deploy contracts in the following order:  
...
8. artzero-nft.js (contain address and abi for PMP contract - the NFT created by Artzero team. For testing purpose, can prepare any collection to put it in) 
