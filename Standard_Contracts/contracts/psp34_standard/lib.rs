...
pub mod psp34_nft {
    ...
    pub struct Psp34Nft {
        ...
        #[storage_field]
        admin: standard_contracts::impls::admin::data::Data,
    }
    ...
    impl AdminTraitImpl for Psp34Nft {}
    ...
    impl Psp34Nft {
        ...
        pub fn mint_with_attributes(&mut self, metadata: Vec<(String, String)>) -> Result<(), Error> {
            ...
            if let Some(last_token_id) = self.manager.last_token_id.checked_add(1) {
                ...
                if Psp34TraitsImpl::set_multiple_attributes(self, Id::U64(self.manager.last_token_id), metadata).is_err(){
